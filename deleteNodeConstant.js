...
function deleteNode(nodeToDelete) {
  ...
  // modify current node with the value and next from nodeToDelete's next node
  const newVal = nodeToDelete.next.value;
  const newNext = nodeToDelete.next.next;
  
  nodeToDelete.value = newVal;
